...
The bundled phenotype and genotype data are provided for reproducibility of the
associated publication. The GAPIT functions file is the property of the GAPIT
